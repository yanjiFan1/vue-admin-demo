...
const option = {
    baseOption: {
    	color : ['#73a801','#0196ff','#e39704','#00b662','#ea7e53','#eedd78','#73a373','#73b9bc','#7289ab', '#91ca8c','#f49f42'],
        timeline: {
            // y: 0,
            axisType: 'category',
            // realtime: false,
    ...
    options: [
        {
            title: {text: '2007全国数据统计'},
            series: [
                {data: dataMap.dataEstate['2002']},
                {data: dataMap.dataPI['2002']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2002']},
                {data: dataMap.dataTI['2002']}
               
            ]
        },
        {
            title : {text: '2008全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2003']},
                {data: dataMap.dataPI['2003']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2003']},
                {data: dataMap.dataTI['2003']}
            ]
        },
        {
            title : {text: '2009全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2004']},
                {data: dataMap.dataPI['2004']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2004']},
                {data: dataMap.dataTI['2004']}
            ]
        },
        {
            title : {text: '2010全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2005']},
                {data: dataMap.dataPI['2005']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2005']},
                {data: dataMap.dataTI['2005']}
            ]
        },
        {
            title : {text: '2011全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2006']},
                {data: dataMap.dataPI['2006']},
                {type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2006']},
                {data: dataMap.dataTI['2006']}
            ]
        },
        {
            title : {text: '2012全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2007']},
                {data: dataMap.dataPI['2007']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2007']},
                {data: dataMap.dataTI['2007']}
            ]
        },
        {
            title : {text: '2013全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2008']},
                {data: dataMap.dataPI['2008']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2008']},
                {data: dataMap.dataTI['2008']}
            ]
        },
        {
            title : {text: '2014全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2009']},
                {data: dataMap.dataPI['2009']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2009']},
                {data: dataMap.dataTI['2009']}
            ]
        },
        {
            title : {text: '2015全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2010']},
                {data: dataMap.dataPI['2010']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2010']},
                {data: dataMap.dataTI['2010']}
            ]
        },
        {
            title : {text: '2016全国数据统计'},
            series : [
                {data: dataMap.dataEstate['2011']},
                {data: dataMap.dataPI['2011']},
                { type:'line',symbol:'emptyCircle',smooth: true,data: dataMap.dataSI['2011']},
